 ...
 * Autogenerated class
 */
abstract class AutoAnnouncementEntity extends LazySingleton implements IQueryable
{
	/**
	...
	{
		return new AnnouncementEntityLogicalSchema;
	}
	...
	{
		return new AnnouncementEntityPhysicalSchema;
	}
}
